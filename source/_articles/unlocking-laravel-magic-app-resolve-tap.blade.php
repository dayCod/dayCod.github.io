...
@section('seo-description')
    Discover the real-world uses of Laravel app(), resolve(), and tap() functions, and how they simplify dependency injection and service resolution in Laravel apps.
@endsection
        ...
        <section data-section="content" class="pt-12">
            <div class="prose max-w-4xl mx-auto">
                <div class="markdown-style">
                    {!! \Illuminate\Support\Str::of(file_get_contents("https://github.com/dayCod/personal-article/blob/main/unlocking-laravel-magic-app-resolve-tap/content.md?raw=true"))->markdown() !!}
                </div>
            </div>
        </section>
