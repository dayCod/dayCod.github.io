...
@section('seo-description')
    Discover the power of Laravel pipelines to write clean, flexible, and maintainable code by processing data through customizable stages.
@endsection
        ...
        <section data-section="content" class="pt-12">
            <div class="prose max-w-4xl mx-auto">
                <div class="markdown-style">
                    {!! \Illuminate\Support\Str::of(file_get_contents("https://github.com/dayCod/personal-article/blob/main/unlocking-laravel-magic-mastering-pipelines/content.md?raw=true"))->markdown() !!}
                </div>
            </div>
        </section>
