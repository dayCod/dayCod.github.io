...
@section('seo-description')
    Prevent duplicate submissions and ensure safe API calls in Laravel with the powerful idempotency key technique.
@endsection

@section('seo-keywords')
    Laravel idempotency key
@endsection
        ...
        <section data-section="content" class="pt-12">
            <div class="prose max-w-4xl mx-auto">
                <div class="markdown-style">
                    {!! \Illuminate\Support\Str::of(file_get_contents("https://github.com/dayCod/personal-article/blob/main/laravel-idempotency-key-safe-requests/content.md?raw=true"))->markdown() !!}
                </div>
            </div>
        </section>
